...
namespace GameServer.Networks
{
    public class OpCodes
    {
        ...
        public static void Init()
        {
            ...
            Recv.Add(unchecked((short)0x0005), typeof(RequestPlay));
            ...
            Recv.Add(unchecked((short)0x008F), typeof(RequestEnterworld));
            ...
            Send.Add(typeof(ResponseEnterWorld), unchecked((short)0x0020));
