...
-- Dumping data for table sof_account.account_data: ~1 rows (approximately)
DELETE FROM `account_data`;
/*!40000 ALTER TABLE `account_data` DISABLE KEYS */;
INSERT INTO `account_data` (`id`, `username`, `password`, `activated`, `access_level`, `last_ip`, `email`, `balance`, `delete_player_key`) VALUES
	(2, 'test', '098f6bcd4621d373cade4e832627b4f6', 1, 99, '127.0.0.1', 'test@test.ts', 99999, NULL);
